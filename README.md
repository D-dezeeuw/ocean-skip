...
4. In flight: hold anywhere — or hold **SPACE** — to dive 🌶️ while the energy
   meter lasts, or a quick tap/press instead throws a backflip 🌀. The whole
   game is playable on the keyboard. Golden fish-food spheres refill energy
   and bank as shop currency.
5. Aim your dive at the water ahead. **Gold chevrons mark rising faces** —
   hit one and it launches you like a ramp, trading forward speed for height
   (nail it cleanly and you keep most of the speed). **Cyan faces are
   descending** — graze one for a sweet skip that keeps you low and fast.
   That choice, air versus speed, is the core of a run.
6. Drop below the fish's minimum skim speed and it sinks — the sea gets
   darker and rougher the farther you fly.
7. Watch for buoys and seagulls — a hit breaks your combo, but flying close
   without touching one pays out as a near-miss.
8. Skips build a combo multiplier (up to ×5) on food, Big Air, and
...
9. Three missions are always active (menu) for extra food/pearls; complete
   runs earn a bronze/silver/gold medal on the results screen.
10. Watch the **power lane** — the dashed gold line marks the altitude where
   full wind, peak thermal lift, Big Air scoring and pearls all pay out.
11. The sea is named as it roughens ("Easy swell" … "Maelstrom"), and the
   Records screen tracks your bests across every skill stat.
12. Spend food in the shop on permanent upgrades (localStorage save).
